...
export default function CashoutGuide() {
  ...
  return (
    <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '40px 20px', color: '#e0e0e0', lineHeight: '1.6', fontFamily: 'Inter, sans-serif' }}>
      <Link href="/" style={{ color: '#4fc3f7', textDecoration: 'none', display: 'inline-block', marginBottom: '20px' }}>
        &larr; Back
      </Link>

      <h1 style={{ fontSize: '1.8rem', marginBottom: '20px', borderBottom: '1px solid rgba(255,255,255,0.1)', paddingBottom: '10px' }}>
        {t.title}
      </h1>
      <p style={{ fontSize: '0.95rem', marginBottom: '40px', whiteSpace: 'pre-wrap' }}>
        {t.intro}
      </p>

      {/* Step 1 */}
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '1.3rem', color: '#4fc3f7', marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ background: '#4fc3f7', color: '#000', width: '28px', height: '28px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', fontSize: '0.9rem', fontWeight: 'bold' }}>1</span>
          {t.step1Title}
        </h2>
        <div style={{ background: 'rgba(0,0,0,0.3)', padding: '20px', borderRadius: '8px' }}>
          <p style={{ fontSize: '0.95rem', whiteSpace: 'pre-wrap' }}>
            {t.step1Text}<br/>
            {t.step1Note && <span style={{ color: '#ffb74d' }}>{t.step1Note}</span>}
          </p>
        </div>
      </section>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '1.3rem', color: '#4fc3f7', marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ background: '#4fc3f7', color: '#000', width: '28px', height: '28px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', fontSize: '0.9rem', fontWeight: 'bold' }}>2</span>
          {t.step2Title}
        </h2>
        <div style={{ background: 'rgba(0,0,0,0.3)', padding: '20px', borderRadius: '8px' }}>
          <p style={{ fontSize: '0.95rem', whiteSpace: 'pre-wrap' }}>
      ...
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '1.3rem', color: '#4fc3f7', marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '10px' }}>
          <span style={{ background: '#4fc3f7', color: '#000', width: '28px', height: '28px', display: 'inline-flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', fontSize: '0.9rem', fontWeight: 'bold' }}>3</span>
          {t.step3Title}
        </h2>
        <div style={{ background: 'rgba(0,0,0,0.3)', padding: '20px', borderRadius: '8px' }}>
          <p style={{ fontSize: '0.95rem', whiteSpace: 'pre-wrap' }}>
      ...
      {/* Video Guide */}
      <section style={{ marginBottom: '40px' }}>
        <h2 style={{ fontSize: '1.3rem', color: '#4fc3f7', marginBottom: '15px', display: 'flex', alignItems: 'center' }}>
          {t.videoTitle}
          {selectedLang !== 'en-US' && videoNotes[selectedLang] && (
            <span style={{ fontSize: '0.9rem', color: '#ffb74d', marginLeft: '12px', fontWeight: 'normal' }}>
      ...
      {false && t.warningTitle && (
        <section style={{ marginBottom: '40px' }}>
          ...
          <div style={{ background: 'rgba(255, 183, 77, 0.1)', padding: '20px', borderRadius: '8px', borderLeft: '4px solid #ffb74d' }}>
            <p style={{ fontSize: '0.95rem', whiteSpace: 'pre-wrap' }}>
              {t.warningText}
            </p>
          </div>
      ...
      <section style={{ marginTop: '40px', paddingTop: '40px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
        <h2 style={{ fontSize: '1.3rem', color: '#4fc3f7', marginBottom: '15px' }}>
          {t.footerTitle}
        </h2>
        <p style={{ fontSize: '0.95rem', marginBottom: '20px', whiteSpace: 'pre-wrap' }}>
          {t.footerText}
        </p>
